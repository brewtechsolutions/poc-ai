...
import CompareAgent from '../agents/compare-agent.js';
...
class WorkflowEngine {
  ...
  /**
   * Compare bikes — delegates to smart-compare.js.
   */
  async handleCompareBikes(node, context) {
    return CompareAgent.handleCompareBikes.call(this, node, context);
  }
